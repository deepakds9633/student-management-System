            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    <button onClick={() => navigate(`/edit-student/${id}`)}
                        className="px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold flex items-center gap-2 hover:bg-slate-50 transition-all">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className="px-8 pb-8 relative">
                    <div className="flex flex-col md:flex-row items-center md:items-end gap-6 -mt-16">
                        <div className="p-1.5 bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl border border-slate-100 dark:border-slate-800 relative group">
                            ...
                            <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-success rounded-full border-4 border-white dark:border-slate-900 flex items-center justify-center">
                        ...
                        <div className="flex items-center gap-3 border border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-3xl backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 p-3 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                                <div className="p-2.5 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 text-primary"><Phone size={18} /></div>
                                <div>
                            ...
                            <div className="flex items-start gap-4 p-3 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                                <div className="p-2.5 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 text-accent"><MapPin size={18} /></div>
                                <div>
                    ...
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}
                        className="md-card p-8 bg-black/5 dark:bg-white/5 border border-primary/20 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <button className="w-full py-2.5 bg-white dark:bg-slate-800 rounded-xl text-[10px] font-black uppercase tracking-widest border border-slate-200 dark:border-slate-700 hover:border-primary transition-all">
                ...
                <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <BarChart data={gradeData} layout="vertical">
                                        ...
                                        <Bar dataKey="score" radius={[0, 6, 6, 0]} barSize={14}>
                                            {gradeData.map((entry, index) => (
                                                <Cell key={`cell-${index}`} fill={entry.score > 90 ? 'var(--success)' : entry.score > 80 ? 'var(--primary)' : 'var(--warning)'} />
                                            ))}
                                        </Bar>
                                    </BarChart>
                                </ResponsiveContainer>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
                        ...
                        <div className="p-8 space-y-10 relative">
                            <div className="absolute top-10 bottom-10 left-[39px] w-px bg-slate-100 dark:bg-slate-800" />
                            {[
                                ...
                                <div key={i} className="flex gap-8 items-start relative group">
                                    <div className="w-6 h-6 rounded-full bg-white dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 relative z-10 mt-1 flex-shrink-0 flex items-center justify-center transition-all group-hover:border-primary group-hover:scale-110">
